...
public:
    ...
    SafeArray(const SafeArray& arrayToCopy);

    /// переопределение оператора присваивания

    SafeArray& operator =(const SafeArray& arrayToCopy);
...
protected:
    ...
    /// метод копирования элементов одного массива в другой (используется для упрощения конструкции в методе присваивания)
    void copy(const SafeArray& arrayToCopy);

    /// метод пересоздания массива (используется в методе присваивания)
    void creationNew(size_t cap);
